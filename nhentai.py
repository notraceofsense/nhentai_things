...
# TODO: Batch jobs (DONE), multithreading, implement saving jsons, idk.
...
for n in id_list:
	# Print the book being downloaded.
	print(n)
	...
	print("\tGetting metadata from nhentai...")
	...
	for x in book_json["images"]["pages"]:
		...
		print("\t\t{} downloaded.".format("{}/{}".format(gallery_url, filename)))
